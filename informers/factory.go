...
func NewSharedInformerFactory(client kubernetes.Interface) SharedInformerFactory {
	return NewSharedInformerFactoryWithOptions(client)
}
...
func NewFilteredSharedInformerFactory(client kubernetes.Interface, namespace string, tweakListOptions internalinterfaces.TweakListOptionsFunc) SharedInformerFactory {
	return NewSharedInformerFactoryWithOptions(client, WithNamespace(namespace), WithTweakListOptions(tweakListOptions))
}

// NewSharedInformerFactoryWithOptions constructs a new instance of a SharedInformerFactory with additional options.
func NewSharedInformerFactoryWithOptions(client kubernetes.Interface, options ...SharedInformerOption) SharedInformerFactory {
...
func (f *sharedInformerFactory) WaitForCacheSync(ctx context.Context) map[reflect.Type]bool {
	...
	for informType, informer := range informers {
		res[informType] = cache.WaitForCacheSync(ctx, informer.HasSynced)
	}
	return res
}
...
type SharedInformerFactory interface {
	...
	WaitForCacheSync(ctx context.Context) map[reflect.Type]bool
