...
type ListFunc func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error)

// WatchFunc knows how to watch resources
type WatchFunc func(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error)
...
func (lw *ListWatch) List(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
...
func (lw *ListWatch) Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error) {
