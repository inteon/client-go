...
func (c *FakeCronJobs) List(ctx context.Context, opts v1.ListOptions) (result *batchv1.CronJobList, err error) {
	...
	list := &batchv1.CronJobList{
		TypeMeta: obj.(*batchv1.CronJobList).TypeMeta,
		ListMeta: obj.(*batchv1.CronJobList).ListMeta,
	}
...
func (c *FakeCronJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
