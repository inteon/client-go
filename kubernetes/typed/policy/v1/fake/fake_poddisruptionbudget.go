...
func (c *FakePodDisruptionBudgets) List(ctx context.Context, opts v1.ListOptions) (result *policyv1.PodDisruptionBudgetList, err error) {
	...
	list := &policyv1.PodDisruptionBudgetList{
		TypeMeta: obj.(*policyv1.PodDisruptionBudgetList).TypeMeta,
		ListMeta: obj.(*policyv1.PodDisruptionBudgetList).ListMeta,
	}
...
func (c *FakePodDisruptionBudgets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
