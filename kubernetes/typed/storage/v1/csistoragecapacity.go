...
type CSIStorageCapacityInterface interface {
	Create(ctx context.Context, cSIStorageCapacity *v1.CSIStorageCapacity, options metav1.CreateOptions) (*v1.CSIStorageCapacity, error)
	Update(ctx context.Context, cSIStorageCapacity *v1.CSIStorageCapacity, options metav1.UpdateOptions) (*v1.CSIStorageCapacity, error)
	Delete(ctx context.Context, name string, options metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(ctx context.Context, name string, options metav1.GetOptions) (*v1.CSIStorageCapacity, error)
	List(ctx context.Context, options metav1.ListOptions) (*v1.CSIStorageCapacityList, error)
	Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.CSIStorageCapacity, err error)
	Apply(ctx context.Context, cSIStorageCapacity *storagev1.CSIStorageCapacityApplyConfiguration, options metav1.ApplyOptions) (result *v1.CSIStorageCapacity, err error)
...
func (c *cSIStorageCapacities) List(ctx context.Context, options metav1.ListOptions) (result *v1.CSIStorageCapacityList, err error) {
...
func (c *cSIStorageCapacities) Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *cSIStorageCapacities) Create(ctx context.Context, cSIStorageCapacity *v1.CSIStorageCapacity, options metav1.CreateOptions) (result *v1.CSIStorageCapacity, err error) {
	result = &v1.CSIStorageCapacity{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *cSIStorageCapacities) Update(ctx context.Context, cSIStorageCapacity *v1.CSIStorageCapacity, options metav1.UpdateOptions) (result *v1.CSIStorageCapacity, err error) {
	result = &v1.CSIStorageCapacity{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *cSIStorageCapacities) Delete(ctx context.Context, name string, options metav1.DeleteOptions) error {
...
func (c *cSIStorageCapacities) DeleteCollection(ctx context.Context, options metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cSIStorageCapacities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.CSIStorageCapacity, err error) {
	result = &v1.CSIStorageCapacity{}
...
func (c *cSIStorageCapacities) Apply(ctx context.Context, cSIStorageCapacity *storagev1.CSIStorageCapacityApplyConfiguration, options metav1.ApplyOptions) (result *v1.CSIStorageCapacity, err error) {
