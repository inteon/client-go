...
type CSIDriverInterface interface {
	Create(ctx context.Context, cSIDriver *v1.CSIDriver, options metav1.CreateOptions) (*v1.CSIDriver, error)
	Update(ctx context.Context, cSIDriver *v1.CSIDriver, options metav1.UpdateOptions) (*v1.CSIDriver, error)
	Delete(ctx context.Context, name string, options metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(ctx context.Context, name string, options metav1.GetOptions) (*v1.CSIDriver, error)
	List(ctx context.Context, options metav1.ListOptions) (*v1.CSIDriverList, error)
	Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error)
	Apply(ctx context.Context, cSIDriver *storagev1.CSIDriverApplyConfiguration, options metav1.ApplyOptions) (result *v1.CSIDriver, err error)
	CSIDriverExpansion
}
...
func (c *cSIDrivers) List(ctx context.Context, options metav1.ListOptions) (result *v1.CSIDriverList, err error) {
...
func (c *cSIDrivers) Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *cSIDrivers) Create(ctx context.Context, cSIDriver *v1.CSIDriver, options metav1.CreateOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *cSIDrivers) Update(ctx context.Context, cSIDriver *v1.CSIDriver, options metav1.UpdateOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *cSIDrivers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
...
func (c *cSIDrivers) Apply(ctx context.Context, cSIDriver *storagev1.CSIDriverApplyConfiguration, options metav1.ApplyOptions) (result *v1.CSIDriver, err error) {
	if cSIDriver == nil {
