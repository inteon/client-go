...
type CSINodeInterface interface {
	Create(ctx context.Context, cSINode *v1beta1.CSINode, options v1.CreateOptions) (*v1beta1.CSINode, error)
	Update(ctx context.Context, cSINode *v1beta1.CSINode, options v1.UpdateOptions) (*v1beta1.CSINode, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1beta1.CSINode, error)
	List(ctx context.Context, options v1.ListOptions) (*v1beta1.CSINodeList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.CSINode, err error)
	Apply(ctx context.Context, cSINode *storagev1beta1.CSINodeApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.CSINode, err error)
	CSINodeExpansion
}
...
func (c *cSINodes) List(ctx context.Context, options v1.ListOptions) (result *v1beta1.CSINodeList, err error) {
...
func (c *cSINodes) Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *cSINodes) Create(ctx context.Context, cSINode *v1beta1.CSINode, options v1.CreateOptions) (result *v1beta1.CSINode, err error) {
	result = &v1beta1.CSINode{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *cSINodes) Update(ctx context.Context, cSINode *v1beta1.CSINode, options v1.UpdateOptions) (result *v1beta1.CSINode, err error) {
	result = &v1beta1.CSINode{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *cSINodes) Delete(ctx context.Context, name string, options v1.DeleteOptions) error {
...
func (c *cSINodes) DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cSINodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.CSINode, err error) {
	result = &v1beta1.CSINode{}
...
func (c *cSINodes) Apply(ctx context.Context, cSINode *storagev1beta1.CSINodeApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.CSINode, err error) {
	if cSINode == nil {
