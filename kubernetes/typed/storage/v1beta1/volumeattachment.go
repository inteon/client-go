...
type VolumeAttachmentInterface interface {
	Create(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.CreateOptions) (*v1beta1.VolumeAttachment, error)
	Update(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.UpdateOptions) (*v1beta1.VolumeAttachment, error)
	UpdateStatus(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.UpdateOptions) (*v1beta1.VolumeAttachment, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1beta1.VolumeAttachment, error)
	List(ctx context.Context, options v1.ListOptions) (*v1beta1.VolumeAttachmentList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeAttachment, err error)
	Apply(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error)
	ApplyStatus(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error)
...
func (c *volumeAttachments) List(ctx context.Context, options v1.ListOptions) (result *v1beta1.VolumeAttachmentList, err error) {
...
func (c *volumeAttachments) Create(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.CreateOptions) (result *v1beta1.VolumeAttachment, err error) {
	result = &v1beta1.VolumeAttachment{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *volumeAttachments) Update(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.UpdateOptions) (result *v1beta1.VolumeAttachment, err error) {
	result = &v1beta1.VolumeAttachment{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *volumeAttachments) UpdateStatus(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, options v1.UpdateOptions) (result *v1beta1.VolumeAttachment, err error) {
	result = &v1beta1.VolumeAttachment{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *volumeAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeAttachment, err error) {
	result = &v1beta1.VolumeAttachment{}
...
func (c *volumeAttachments) Apply(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error) {
...
func (c *volumeAttachments) ApplyStatus(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error) {
	if volumeAttachment == nil {
		return nil, fmt.Errorf("volumeAttachment provided to Apply must not be nil")
	}
	patchOpts := options.ToPatchOptions()
