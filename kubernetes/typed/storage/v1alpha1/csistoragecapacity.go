...
type CSIStorageCapacityInterface interface {
	Create(ctx context.Context, cSIStorageCapacity *v1alpha1.CSIStorageCapacity, options v1.CreateOptions) (*v1alpha1.CSIStorageCapacity, error)
	Update(ctx context.Context, cSIStorageCapacity *v1alpha1.CSIStorageCapacity, options v1.UpdateOptions) (*v1alpha1.CSIStorageCapacity, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1alpha1.CSIStorageCapacity, error)
	List(ctx context.Context, options v1.ListOptions) (*v1alpha1.CSIStorageCapacityList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1alpha1.CSIStorageCapacity, err error)
	Apply(ctx context.Context, cSIStorageCapacity *storagev1alpha1.CSIStorageCapacityApplyConfiguration, options v1.ApplyOptions) (result *v1alpha1.CSIStorageCapacity, err error)
...
func (c *cSIStorageCapacities) List(ctx context.Context, options v1.ListOptions) (result *v1alpha1.CSIStorageCapacityList, err error) {
...
func (c *cSIStorageCapacities) Create(ctx context.Context, cSIStorageCapacity *v1alpha1.CSIStorageCapacity, options v1.CreateOptions) (result *v1alpha1.CSIStorageCapacity, err error) {
	result = &v1alpha1.CSIStorageCapacity{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1alpha1.SchemeGroupVersion).
...
func (c *cSIStorageCapacities) Update(ctx context.Context, cSIStorageCapacity *v1alpha1.CSIStorageCapacity, options v1.UpdateOptions) (result *v1alpha1.CSIStorageCapacity, err error) {
	result = &v1alpha1.CSIStorageCapacity{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1alpha1.SchemeGroupVersion).
...
func (c *cSIStorageCapacities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1alpha1.CSIStorageCapacity, err error) {
	result = &v1alpha1.CSIStorageCapacity{}
...
func (c *cSIStorageCapacities) Apply(ctx context.Context, cSIStorageCapacity *storagev1alpha1.CSIStorageCapacityApplyConfiguration, options v1.ApplyOptions) (result *v1alpha1.CSIStorageCapacity, err error) {
