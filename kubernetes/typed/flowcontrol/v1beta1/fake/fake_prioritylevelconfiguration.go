...
func (c *FakePriorityLevelConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PriorityLevelConfigurationList, err error) {
	...
	list := &v1beta1.PriorityLevelConfigurationList{
		TypeMeta: obj.(*v1beta1.PriorityLevelConfigurationList).TypeMeta,
		ListMeta: obj.(*v1beta1.PriorityLevelConfigurationList).ListMeta,
	}
...
func (c *FakePriorityLevelConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
