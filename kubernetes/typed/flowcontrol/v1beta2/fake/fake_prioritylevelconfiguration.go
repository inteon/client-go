...
func (c *FakePriorityLevelConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.PriorityLevelConfigurationList, err error) {
	...
	list := &v1beta2.PriorityLevelConfigurationList{
		TypeMeta: obj.(*v1beta2.PriorityLevelConfigurationList).TypeMeta,
		ListMeta: obj.(*v1beta2.PriorityLevelConfigurationList).ListMeta,
	}
