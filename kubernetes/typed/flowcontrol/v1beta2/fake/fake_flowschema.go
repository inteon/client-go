...
func (c *FakeFlowSchemas) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.FlowSchemaList, err error) {
	...
	list := &v1beta2.FlowSchemaList{
		TypeMeta: obj.(*v1beta2.FlowSchemaList).TypeMeta,
		ListMeta: obj.(*v1beta2.FlowSchemaList).ListMeta,
	}
...
func (c *FakeFlowSchemas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
