...
type LocalSubjectAccessReviewInterface interface {
	Create(ctx context.Context, localSubjectAccessReview *v1beta1.LocalSubjectAccessReview, options v1.CreateOptions) (*v1beta1.LocalSubjectAccessReview, error)
...
func (c *localSubjectAccessReviews) Create(ctx context.Context, localSubjectAccessReview *v1beta1.LocalSubjectAccessReview, options v1.CreateOptions) (result *v1beta1.LocalSubjectAccessReview, err error) {
	...
	err = c.client.Post().
		...
		ExpectKind("LocalSubjectAccessReview").
		Do(ctx).
		Into(result)
	return
}
