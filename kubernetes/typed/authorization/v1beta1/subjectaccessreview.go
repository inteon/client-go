...
type SubjectAccessReviewInterface interface {
	Create(ctx context.Context, subjectAccessReview *v1beta1.SubjectAccessReview, options v1.CreateOptions) (*v1beta1.SubjectAccessReview, error)
...
func (c *subjectAccessReviews) Create(ctx context.Context, subjectAccessReview *v1beta1.SubjectAccessReview, options v1.CreateOptions) (result *v1beta1.SubjectAccessReview, err error) {
