...
type LocalSubjectAccessReviewInterface interface {
	Create(ctx context.Context, localSubjectAccessReview *v1.LocalSubjectAccessReview, options metav1.CreateOptions) (*v1.LocalSubjectAccessReview, error)
...
func (c *localSubjectAccessReviews) Create(ctx context.Context, localSubjectAccessReview *v1.LocalSubjectAccessReview, options metav1.CreateOptions) (result *v1.LocalSubjectAccessReview, err error) {
