...
type PriorityClassInterface interface {
	Create(ctx context.Context, priorityClass *v1alpha1.PriorityClass, options v1.CreateOptions) (*v1alpha1.PriorityClass, error)
	Update(ctx context.Context, priorityClass *v1alpha1.PriorityClass, options v1.UpdateOptions) (*v1alpha1.PriorityClass, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1alpha1.PriorityClass, error)
	List(ctx context.Context, options v1.ListOptions) (*v1alpha1.PriorityClassList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1alpha1.PriorityClass, err error)
	Apply(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClassApplyConfiguration, options v1.ApplyOptions) (result *v1alpha1.PriorityClass, err error)
...
func (c *priorityClasses) List(ctx context.Context, options v1.ListOptions) (result *v1alpha1.PriorityClassList, err error) {
...
func (c *priorityClasses) Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *priorityClasses) Create(ctx context.Context, priorityClass *v1alpha1.PriorityClass, options v1.CreateOptions) (result *v1alpha1.PriorityClass, err error) {
	result = &v1alpha1.PriorityClass{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1alpha1.SchemeGroupVersion).
...
func (c *priorityClasses) Update(ctx context.Context, priorityClass *v1alpha1.PriorityClass, options v1.UpdateOptions) (result *v1alpha1.PriorityClass, err error) {
	result = &v1alpha1.PriorityClass{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1alpha1.SchemeGroupVersion).
...
func (c *priorityClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1alpha1.PriorityClass, err error) {
	result = &v1alpha1.PriorityClass{}
...
func (c *priorityClasses) Apply(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClassApplyConfiguration, options v1.ApplyOptions) (result *v1alpha1.PriorityClass, err error) {
