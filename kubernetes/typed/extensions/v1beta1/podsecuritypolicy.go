...
type PodSecurityPolicyInterface interface {
	...
	Apply(ctx context.Context, podSecurityPolicy *extensionsv1beta1.PodSecurityPolicyApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.PodSecurityPolicy, err error)
...
func (c *podSecurityPolicies) Apply(ctx context.Context, podSecurityPolicy *extensionsv1beta1.PodSecurityPolicyApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.PodSecurityPolicy, err error) {
