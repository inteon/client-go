...
func (c *FakeRuntimeClasses) List(ctx context.Context, opts v1.ListOptions) (result *nodev1.RuntimeClassList, err error) {
	...
	list := &nodev1.RuntimeClassList{
		TypeMeta: obj.(*nodev1.RuntimeClassList).TypeMeta,
		ListMeta: obj.(*nodev1.RuntimeClassList).ListMeta,
	}
...
func (c *FakeRuntimeClasses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
