...
type LeaseInterface interface {
	Create(ctx context.Context, lease *v1.Lease, options metav1.CreateOptions) (*v1.Lease, error)
	Update(ctx context.Context, lease *v1.Lease, options metav1.UpdateOptions) (*v1.Lease, error)
	Delete(ctx context.Context, name string, options metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(ctx context.Context, name string, options metav1.GetOptions) (*v1.Lease, error)
	List(ctx context.Context, options metav1.ListOptions) (*v1.LeaseList, error)
	Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.Lease, err error)
	Apply(ctx context.Context, lease *coordinationv1.LeaseApplyConfiguration, options metav1.ApplyOptions) (result *v1.Lease, err error)
	LeaseExpansion
}
...
func (c *leases) List(ctx context.Context, options metav1.ListOptions) (result *v1.LeaseList, err error) {
...
func (c *leases) Watch(ctx context.Context, options metav1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *leases) Create(ctx context.Context, lease *v1.Lease, options metav1.CreateOptions) (result *v1.Lease, err error) {
	result = &v1.Lease{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *leases) Update(ctx context.Context, lease *v1.Lease, options metav1.UpdateOptions) (result *v1.Lease, err error) {
	result = &v1.Lease{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1.SchemeGroupVersion).
...
func (c *leases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options metav1.PatchOptions, subresources ...string) (result *v1.Lease, err error) {
	result = &v1.Lease{}
...
func (c *leases) Apply(ctx context.Context, lease *coordinationv1.LeaseApplyConfiguration, options metav1.ApplyOptions) (result *v1.Lease, err error) {
	if lease == nil {
