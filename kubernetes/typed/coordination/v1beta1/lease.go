...
type LeaseInterface interface {
	Create(ctx context.Context, lease *v1beta1.Lease, options v1.CreateOptions) (*v1beta1.Lease, error)
	Update(ctx context.Context, lease *v1beta1.Lease, options v1.UpdateOptions) (*v1beta1.Lease, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1beta1.Lease, error)
	List(ctx context.Context, options v1.ListOptions) (*v1beta1.LeaseList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.Lease, err error)
	Apply(ctx context.Context, lease *coordinationv1beta1.LeaseApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.Lease, err error)
	LeaseExpansion
}
...
func (c *leases) List(ctx context.Context, options v1.ListOptions) (result *v1beta1.LeaseList, err error) {
...
func (c *leases) Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *leases) Create(ctx context.Context, lease *v1beta1.Lease, options v1.CreateOptions) (result *v1beta1.Lease, err error) {
	result = &v1beta1.Lease{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *leases) Update(ctx context.Context, lease *v1beta1.Lease, options v1.UpdateOptions) (result *v1beta1.Lease, err error) {
	result = &v1beta1.Lease{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *leases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.Lease, err error) {
	result = &v1beta1.Lease{}
...
func (c *leases) Apply(ctx context.Context, lease *coordinationv1beta1.LeaseApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.Lease, err error) {
	if lease == nil {
