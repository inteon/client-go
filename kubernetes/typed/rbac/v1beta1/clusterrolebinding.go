...
type ClusterRoleBindingInterface interface {
	Create(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, options v1.CreateOptions) (*v1beta1.ClusterRoleBinding, error)
	Update(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, options v1.UpdateOptions) (*v1beta1.ClusterRoleBinding, error)
	...
	List(ctx context.Context, options v1.ListOptions) (*v1beta1.ClusterRoleBindingList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error)
	Apply(ctx context.Context, clusterRoleBinding *rbacv1beta1.ClusterRoleBindingApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.ClusterRoleBinding, err error)
...
func (c *clusterRoleBindings) List(ctx context.Context, options v1.ListOptions) (result *v1beta1.ClusterRoleBindingList, err error) {
...
func (c *clusterRoleBindings) Create(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, options v1.CreateOptions) (result *v1beta1.ClusterRoleBinding, err error) {
	result = &v1beta1.ClusterRoleBinding{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *clusterRoleBindings) Update(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, options v1.UpdateOptions) (result *v1beta1.ClusterRoleBinding, err error) {
	result = &v1beta1.ClusterRoleBinding{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *clusterRoleBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error) {
	result = &v1beta1.ClusterRoleBinding{}
...
func (c *clusterRoleBindings) Apply(ctx context.Context, clusterRoleBinding *rbacv1beta1.ClusterRoleBindingApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.ClusterRoleBinding, err error) {
