...
func (c *FakeIngresses) List(ctx context.Context, opts v1.ListOptions) (result *networkingv1.IngressList, err error) {
	...
	list := &networkingv1.IngressList{
		TypeMeta: obj.(*networkingv1.IngressList).TypeMeta,
		ListMeta: obj.(*networkingv1.IngressList).ListMeta,
	}
...
func (c *FakeIngresses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Watcher, error) {
	return c.Fake.
