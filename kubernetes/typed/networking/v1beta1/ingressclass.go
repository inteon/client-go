...
type IngressClassInterface interface {
	Create(ctx context.Context, ingressClass *v1beta1.IngressClass, options v1.CreateOptions) (*v1beta1.IngressClass, error)
	Update(ctx context.Context, ingressClass *v1beta1.IngressClass, options v1.UpdateOptions) (*v1beta1.IngressClass, error)
	Delete(ctx context.Context, name string, options v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1beta1.IngressClass, error)
	List(ctx context.Context, options v1.ListOptions) (*v1beta1.IngressClassList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.IngressClass, err error)
	Apply(ctx context.Context, ingressClass *networkingv1beta1.IngressClassApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.IngressClass, err error)
...
func (c *ingressClasses) List(ctx context.Context, options v1.ListOptions) (result *v1beta1.IngressClassList, err error) {
...
func (c *ingressClasses) Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error) {
	var timeout time.Duration
	if options.TimeoutSeconds != nil {
		timeout = time.Duration(*options.TimeoutSeconds) * time.Second
	}
...
func (c *ingressClasses) Create(ctx context.Context, ingressClass *v1beta1.IngressClass, options v1.CreateOptions) (result *v1beta1.IngressClass, err error) {
	result = &v1beta1.IngressClass{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *ingressClasses) Update(ctx context.Context, ingressClass *v1beta1.IngressClass, options v1.UpdateOptions) (result *v1beta1.IngressClass, err error) {
	result = &v1beta1.IngressClass{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta1.SchemeGroupVersion).
...
func (c *ingressClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta1.IngressClass, err error) {
	result = &v1beta1.IngressClass{}
...
func (c *ingressClasses) Apply(ctx context.Context, ingressClass *networkingv1beta1.IngressClassApplyConfiguration, options v1.ApplyOptions) (result *v1beta1.IngressClass, err error) {
	if ingressClass == nil {
