...
type ControllerRevisionInterface interface {
	Create(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, options v1.CreateOptions) (*v1beta2.ControllerRevision, error)
	Update(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, options v1.UpdateOptions) (*v1beta2.ControllerRevision, error)
	...
	List(ctx context.Context, options v1.ListOptions) (*v1beta2.ControllerRevisionList, error)
	Watch(ctx context.Context, options v1.ListOptions) (watch.Watcher, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error)
	Apply(ctx context.Context, controllerRevision *appsv1beta2.ControllerRevisionApplyConfiguration, options v1.ApplyOptions) (result *v1beta2.ControllerRevision, err error)
...
func (c *controllerRevisions) List(ctx context.Context, options v1.ListOptions) (result *v1beta2.ControllerRevisionList, err error) {
...
func (c *controllerRevisions) Create(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, options v1.CreateOptions) (result *v1beta2.ControllerRevision, err error) {
	result = &v1beta2.ControllerRevision{}
	err = c.client.Post().
		ApiPath("/apis").
		GroupVersion(v1beta2.SchemeGroupVersion).
...
func (c *controllerRevisions) Update(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, options v1.UpdateOptions) (result *v1beta2.ControllerRevision, err error) {
	result = &v1beta2.ControllerRevision{}
	err = c.client.Put().
		ApiPath("/apis").
		GroupVersion(v1beta2.SchemeGroupVersion).
...
func (c *controllerRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, options v1.PatchOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error) {
	result = &v1beta2.ControllerRevision{}
...
func (c *controllerRevisions) Apply(ctx context.Context, controllerRevision *appsv1beta2.ControllerRevisionApplyConfiguration, options v1.ApplyOptions) (result *v1beta2.ControllerRevision, err error) {
